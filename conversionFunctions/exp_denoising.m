...
arguments (Input)
    foldername = 'C:\Users\sverrsr\Documents\experiments\re2500_we20_rayTrace_png_test';
end
...
% Other settings
gpu = true;
cache_path_name = fullfile('cache_DENOISED_2500_3','png_input');
...
for frame = frame_start:frame_step:frame_end-K+1
    ...
    lam_s = 5e-2/2;   % spatial regularization coefficient 0.05
    lam_t = 15e-2/2;  % temporal regularization coefficient 0.15

    n_iters = 150/2;  % number of iterations
