...
arguments (Input)
    inFolder = "C:\Users\sverrsr\Documents\experiments\padding\cache_DENOISED_2500_3\png_input\denoised_png";
end
...
outputVideo = VideoWriter(fullfile(workingDir, "video2500_3"), 'MPEG-4');
